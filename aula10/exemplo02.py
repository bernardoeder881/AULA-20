...
#   Quanto mais próximo do Q3, maior a dispersão
    ...
    print(f'Q3: {q3}')
    print(f'IQR: {iqr}') #É a amplitude dos 50% dos dados mais centrais
...
try:
    #Assimetria
    # Medida q indica como os dados estão distribuidos em torno do valoe central
    # Estão distribuidos em torno do Centro?
    # Exixte uma qtd maior de registos maiores ou menores?
    # Para que lado está o peso.
    # É a medida usada para descrever o grau de assimetria

    # INTERPRETAÇÃO:
    # ASSIMETRIA >1: Positva Alta
    ...
    # Temdência de dados equilibrados
    ...
    print('Erro ao calcular outliers')
...
try:
    ...
    plt.text(0.1,0.7,f'Distancia:: {distancia}', fontsize=12)
